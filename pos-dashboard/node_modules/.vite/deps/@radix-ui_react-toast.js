...
function createSlot5(ownerName) {
  ...
  const Slot22 = React20.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime14.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React20.isValidElement(newElement) ? React20.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function isSlottable5(child) {
  return React20.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER5;
}
...
var ToastProvider = (props) => {
  ...
  return (0, import_jsx_runtime17.jsx)(Collection.Provider, { scope: __scopeToast, children: (0, import_jsx_runtime17.jsx)(
  ...
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime17.jsxs)(
      Branch,
      {
        ...
        children: [
          hasToasts && (0, import_jsx_runtime17.jsx)(
            FocusProxy,
            {
          ...
          (0, import_jsx_runtime17.jsx)(Collection.Slot, { scope: __scopeToast, children: (0, import_jsx_runtime17.jsx)(Primitive3.ol, { tabIndex: -1, ...viewportProps, ref: composedRefs }) }),
          hasToasts && (0, import_jsx_runtime17.jsx)(
            FocusProxy,
            {
...
var Toast = React26.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime17.jsx)(Presence, { present: forceMount || open, children: (0, import_jsx_runtime17.jsx)(
      ToastImpl,
      {
        open,
        ...toastProps,
...
var ToastImpl = React26.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime17.jsxs)(import_jsx_runtime17.Fragment, { children: [
      announceTextContent && (0, import_jsx_runtime17.jsx)(
        ToastAnnounce,
        {
          __scopeToast,
          role: "status",
      ...
      (0, import_jsx_runtime17.jsx)(ToastInteractiveProvider, { scope: __scopeToast, onClose: handleClose, children: ReactDOM6.createPortal(
        (0, import_jsx_runtime17.jsx)(Collection.ItemSlot, { scope: __scopeToast, children: (0, import_jsx_runtime17.jsx)(
          Root,
          {
            asChild: true,
...
var ToastAnnounce = (props) => {
  ...
  return isAnnounced ? null : (0, import_jsx_runtime17.jsx)(Portal, { asChild: true, children: (0, import_jsx_runtime17.jsx)(VisuallyHidden, { ...announceProps, children: renderAnnounceText && (0, import_jsx_runtime17.jsxs)(import_jsx_runtime17.Fragment, { children: [
    context.label,
    " ",
    children
  ] }) }) });
...
var ToastTitle = React26.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime17.jsx)(Primitive3.div, { ...titleProps, ref: forwardedRef });
  }
);
...
var ToastDescription = React26.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime17.jsx)(Primitive3.div, { ...descriptionProps, ref: forwardedRef });
  }
);
...
var ToastAction = React26.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime17.jsx)(ToastAnnounceExclude, { altText, asChild: true, children: (0, import_jsx_runtime17.jsx)(ToastClose, { ...actionProps, ref: forwardedRef }) });
  }
);
...
var ToastClose = React26.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime17.jsx)(ToastAnnounceExclude, { asChild: true, children: (0, import_jsx_runtime17.jsx)(
      Primitive3.button,
      {
        type: "button",
        ...closeProps,
